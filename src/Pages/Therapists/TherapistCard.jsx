...
function TherapistCard() {
  ...
  const filteredTherapists = therapists.filter(
    (therapist) =>
      ...
      therapist.Specialization.toLowerCase().includes(
    ...
    <div>
      ...
      <div className="search-div">
        <input
          ...
          className="seacrh-name"
        />
        <input
          type="text"
          placeholder="Search by specialization"
          onChange={(e) => setSearchSpecialization(e.target.value)}
          className="seacrh-specialization"
        />
      </div>
        ...
        {filteredTherapists.map((therapist) => (
          <div key={therapist.TherapistID} className="card">
            <div className="basic-info">
              ...
              <p className="therapist-details">
                Email Address: {therapist.EmailAddress}
              </p>
            </div>
